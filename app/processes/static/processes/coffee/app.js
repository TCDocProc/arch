...
(function() {
  ...
  jQuery(function() {
    ...
    Processes = (function(superClass) {
      extend(Processes, superClass);
    ...
    ActionView = (function(superClass) {
    ...
    BranchView = (function(superClass) {
    ...
    SequenceView = (function(superClass) {
      extend(SequenceView, superClass);
    ...
    ProcessesView = (function(superClass) {
      extend(ProcessesView, superClass);
    ...
    MinimapView = (function(superClass) {
      extend(MinimapView, superClass);
      ...
      MinimapView.prototype.moveToPath = function(path) {
        var cv, i, j, k, len, len1, ref, ref1;
